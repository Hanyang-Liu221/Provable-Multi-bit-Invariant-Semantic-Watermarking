...
CONFIG_MAPPING_NAMES = {
    ...
    "pmark": 'watermark.pmark.PmarkConfig',
    "KGW_Multi": 'watermark.KGW_Multi.KGW_MultiConfig',
}
...
class AutoConfig:
    ...
    @classmethod
    def load(cls, algorithm_name: str, transformers_config: TransformersConfig, algorithm_config_path=None,
             **kwargs) -> Any:
        """
